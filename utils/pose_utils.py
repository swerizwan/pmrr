...
def compute_similarity_transform_batch(S1, S2):
    ...
    Args:
        S1 (np.ndarray): Array of shape (N, 3, 3) representing batch of matrices.
        S2 (np.ndarray): Array of shape (N, 3, 3) representing batch of target matrices.

    Returns:
        np.ndarray: Array of shape (N, 3, 3) containing the batched similarity-transformed matrices.
    """
...
def reconstruction_error(S1, S2, reduction='mean'):
    ...
    Args:
        S1 (np.ndarray): Array of shape (N, 3, 3) representing batch of matrices.
        S2 (np.ndarray): Array of shape (N, 3, 3) representing batch of target matrices.
        reduction (str): Specifies the reduction to apply to the error ('mean' or 'sum').

    Returns:
        float: Mean or sum of reconstruction error across the batch.
        np.ndarray: Array of shape (N, 3, 3) containing the batched similarity-transformed matrices.
    """
...
def axis_angle_add(theta, roll_axis, alpha):
    ...
    Args:
        theta (torch.Tensor): Tensor of shape (N, 3) representing axis-angle rotations.
        roll_axis (torch.Tensor): Tensor of shape (N, 3) representing axis of rotation.
        alpha (torch.Tensor): Scalar tensor representing the angle to rotate by.

    Returns:
        torch.Tensor: Tensor of shape (N, 3) representing the resulting axis-angle rotation.
    """
